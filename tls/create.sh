...
cfssl gencert -ca=certs/ca.pem -ca-key=certs/ca-key.pem -config=ca-config.json -profile=client-server core-master-01.json | cfssljson -bare certs/core-master-01
